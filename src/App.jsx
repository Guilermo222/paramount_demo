...
const posterPool = [
  `${baseUrl}posters/p01.webp`,
  `${baseUrl}posters/p02.webp`,
  `${baseUrl}posters/p03.webp`,
  `${baseUrl}posters/p04.webp`,
  `${baseUrl}posters/p05.webp`,
  `${baseUrl}posters/p06.webp`,
  `${baseUrl}posters/p07.webp`,
  `${baseUrl}posters/p08.webp`,
  `${baseUrl}posters/p09.webp`,
  `${baseUrl}posters/p10.webp`,
  `${baseUrl}posters/p11.webp`,
  `${baseUrl}posters/p12.webp`,
  `${baseUrl}posters/p13.webp`,
  `${baseUrl}posters/p14.webp`,
  `${baseUrl}posters/p15.webp`,
  `${baseUrl}posters/p16.webp`,
  `${baseUrl}posters/p17.webp`,
  `${baseUrl}posters/p18.webp`,
  `${baseUrl}posters/p19.webp`,
  `${baseUrl}posters/p20.webp`,
  `${baseUrl}posters/p21.webp`,
  `${baseUrl}posters/p22.webp`,
  `${baseUrl}posters/p23.webp`,
  `${baseUrl}posters/p24.webp`,
  `${baseUrl}posters/p25.webp`,
  `${baseUrl}posters/p26.webp`,
  `${baseUrl}posters/p27.webp`,
  `${baseUrl}posters/p28.webp`,
];
